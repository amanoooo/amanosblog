...
初心是买一个软路由的硬件设备， 最终选了 r2s[https://wiki.friendlyelec.com/wiki/index.php/NanoPi_R2S/zh], rs2内置的是Openwrt 的系统，但是有些预装软件不全面， 就自己刷了系统， 不小心刷盘的时候把树莓派的移动硬盘刷掉了 /(ㄒoㄒ)/~~， 最终只能重新搭建博客啦~
